...
class Registration
{
    ...
    public function sendVerificationEmail($user_id, $user_email, $user_activation_hash)
    {
        ...
        $link = EMAIL_VERIFICATION_URL.'?verify&id='.urlencode($user_id).'&verification_code='.urlencode($user_activation_hash);
        echo EMAIL_VERIFICATION_URL.'?verify&id='.urlencode($user_id).'&verification_code='.urlencode($user_activation_hash).PHP_EOL;
