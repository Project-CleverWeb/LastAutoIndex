...
class MarkdownExtraExtended_Parser extends MarkdownExtra_Parser {
	...
	function _doFencedCodeBlocks_callback($matches) {
		...
		//$cb = "<pre><code";
		$cb = empty($matches[3]) ? "<pre class=\"markdown-pre\"><code class=\"markdown-code\"" : "<pre class=\"markdown-pre linenums:$matches[3]\"><code"; 
		$cb .= empty($matches[2]) ? ">" : " class=\"markdown-code language-$matches[2]\">";
